...
class Match(Base):
    ...
    team1_score: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    team2_score: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    winner_id: Mapped[Optional[int]] = mapped_column(Integer, ForeignKey("teams.id"), nullable=True)
    challonge_match_id: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
